...
class SAbDabDataset(Dataset):
    ...
    def _preprocess_structures(self):
        ...
        logging.info('Preprocess tasks: %d (structure_name=%s)', len(tasks), self.structure_name)
...
####################################################################
        ...
        if mmseqs is None:
            raise FileNotFoundError(
                'mmseqs not found on PATH. Activate the conda env that has it '
                '(e.g. conda activate diffab).'
            )
        cmd = ' '.join([
